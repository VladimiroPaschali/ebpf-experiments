...
EXPERIMENT_NAME = "lpmtrie_sr"
EXPRIMENT_FUNC_NAME = "lpmtrie_sr" # FRANCESCO
...
def parser():
    ...
    parser.add_argument("-e", "--experiment", help = "Name of the experiment (default:lpmtrie_sr)",  metavar="lpmtrie_sr",required = False, default = "lpmtrie_sr")
...
def main():
    try:
        ...
        if not (os.path.exists("lpmtrie_sr.o")):
